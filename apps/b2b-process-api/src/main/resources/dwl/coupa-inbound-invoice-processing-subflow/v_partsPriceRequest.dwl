...
---
{
	ArrayOfItemPriceInfo @("xmlns:xsi": "http://www.w3.org/2001/XMLSchema-instance", "xmlns:xsd": "http://www.w3.org/2001/XMLSchema"): {
        ...
        {
            (ItemId: item.ItemId) if(!isEmpty(item.ItemId)),
            (SourceLocId: vars.poSearchResponse.value[0].preferred_location_id) if(!isEmpty(vars.poSearchResponse.value[0].preferred_location_id)),
