...
fun buildErrorConfig(resolvedType, descStr) =
    if      (resolvedType == "CONNECTIVITY") {
        ...
        message:     "855 transmission failed with error type [CONNECTIVITY] while sending to APM. " ++ descStr,
        resolution:  "The 855 transmission failed because Mule could not connect to the APM endpoint."
        ...
        message:     "855 transmission failed with error type [NOT_FOUND] — the APM endpoint returned HTTP 404. " ++ descStr,
        resolution:  "The 855 transmission failed because the APM endpoint URL returned 404."
        ...
        category:    "TIMEOUT",
        message:     "855 transmission failed with error type [TIMEOUT] — the APM endpoint did not respond within the allowed time. " ++ descStr,
        resolution:  "The 855 transmission timed out waiting for APM."
        ...
        category:    "SECURITY",
        message:     "855 transmission failed with error type [UNAUTHORIZED] — APM rejected the request due to missing or invalid credentials (HTTP 401). " ++ descStr,
        resolution:  "The 855 transmission failed because APM returned 401 Unauthorized."
        ...
        category:    "SECURITY",
        message:     "855 transmission failed with error type [FORBIDDEN] — APM denied access (HTTP 403). " ++ descStr,
        resolution:  "The 855 transmission failed because APM returned 403 Forbidden."
        ...
        message:     "855 transmission failed with error type [SERVER_ERROR] — APM returned a server-side error while processing the 855 Purchase Order. " ++ descStr,
        resolution:  "The 855 transmission failed due to an internal error on the APM side."
        ...
        message:     "855 transmission failed with error type [BAD_REQUEST] — APM rejected the 855 payload with HTTP 400. " ++ descStr,
        resolution:  "The 855 transmission failed because APM could not process the request payload."
                     ++ "\n  1. Review the 855 payload — check for missing required fields or incorrect data types."
        ...
        category:    "VALIDATION",
        message:     "855 transmission failed with error type [VALIDATION] — JSON Schema at Process API Failure. " ++ descStr,
        resolution:  "The 855 transmission failed because one or more fields in the payload did not pass APM validation."
                     ...
                     ++ "\n  3. Validate the 855 payload against the APM API schema and EDI 855 X12 contract requirements."
        ...
        category:    "UNKNOWN",
        message:     "855 transmission failed with error type [" ++ resolvedType ++ "] while sending the 855 Purchase Order to APM. " ++ descStr,
        resolution:  "The 855 transmission failed with an unclassified error type [" ++ resolvedType ++ "] from APM."
...
var data = {
    ...
    flowName:         safe(vars.flowName, "855 Outbound Validation"),
    route:            "P21 → Mule → APM",
